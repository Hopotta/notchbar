...
/// then becomes layered-transparent before the input proof and first show. It
...
public sealed class BackdropHostWindow : IDisposable
{
    ...
    public BackdropHostWindow()
    {
        ...
        _ = DwmSetWindowAttribute(Handle, DwmNcRenderingPolicy, ref ncPolicy, sizeof(int));
    ...
    public bool ShowForProbe(WindowPixelGeometry bounds, IntPtr insertAfter)
    {
    ...
    public bool EnableLayeredTransparency()
    {
        ...
        var activeStyle = unchecked((uint)GetWindowLongPtr(Handle, GwlExStyle).ToInt64());
        return (activeStyle & BackdropWindowPolicy.ActiveExtendedWindowStyle) ==
